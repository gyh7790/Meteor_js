      ...
      <div class="filter-container">
        <el-form :model="queryParams" ref="queryParams" :inline="true">
            <el-form-item label="关键字">
              <el-input v-model="queryParams." placeholder="名称、接口"></el-input>
            </el-form-item>
...
<script>
import banner from '@/api/app/banner'
...
import "@riophae/vue-treeselect/dist/vue-treeselect.css";
  ...
  export default {
    ...
    methods: {
      ...
      getBanner(){
        banner.BANNER_PAGE_LIST(this.queryParams).then((res)=>{
      ...
      saveBanner(){
        ...
        banner.BANNER_SAVE(this.bannerForm).then((res) => {
      ...
      // 删除
      deleteBanner(row){
        banner.BANNER_DELETE(row.id).then(res => {
